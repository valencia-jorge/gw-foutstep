...
axes[1].set(xlabel="Frequencies [Hz]", ylabel=r"$\delta t \cdot $FFT", xscale="log", yscale="log")

axes[0].plot(timestamps, td_samples)

axes[1].plot(frequencies[pos_freqs], np.abs(bare_fd_samples[pos_freqs]), label="No regularisation")
